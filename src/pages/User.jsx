...
const { user, getUser, loading, getRepo, repo } = useContext(GitHubContext);
...
const {
    ...
    return(
    <> 
        <div className='w-full ms-auto lg:w-10/12'>
           <div className='mb-4'>
           ...
           <div className='grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 mb-8 md:gap-8'>
            ...
            <div className='w-full mb-6 rounded-lg shadow-md bg-base-100 stats'>
              <div className='stat'> 
            ...
            <div className='rounded-lg shadow-lg card bg-base-100 '>
               <div className='card-body'>
                  ...
                  {repo.map((item) => <UserRepo repo={item}/>)}
               </div>
            </div>     
        </div>
    </>
